export const Call = () => {
  return (
    ...
    >
      <path
        d="M19.9983 10.999H21.9983C21.9983 5.869 18.1253 2 12.9883 2V4C17.0503 4 19.9983 6.943 19.9983 10.999Z"
        fill="#F4F4F4"
      />
      <path
...
export const Arrow = () => {
  return (
    ...
    >
      <path
        d="M14.5085 3.41614L8.87116 6.67088V0.161393L14.5085 3.41614ZM9.4349 3.97988H0.978827V2.8524H9.4349V3.97988Z"
        fill="#E4E4E4"
      />
    </svg>
  );
...
export const Dots = () => {
  return (
    <svg
      ...
      fill="url(#paint3_linear_2_2003)"
    >
      <path d="M480-160q-33 0-56.5-23.5T400-240q0-33 23.5-56.5T480-320q33 0 56.5 23.5T560-240q0 33-23.5 56.5T480-160Zm0-240q-33 0-56.5-23.5T400-480q0-33 23.5-56.5T480-560q33 0 56.5 23.5T560-480q0 33-23.5 56.5T480-400Zm0-240q-33 0-56.5-23.5T400-720q0-33 23.5-56.5T480-800q33 0 56.5 23.5T560-720q0 33-23.5 56.5T480-640Z" fill="url(#paint3_linear_2_2003)" />
      <defs>
        <linearGradient
          id="paint0_linear_2_2003"
          x1="-9.46355e-08"
...
export const Uparrow = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-160v-487L216-423l-56-57 320-320 320 320-56 57-224-224v487h-80Z" className='fill-white'/></svg>
  )
}